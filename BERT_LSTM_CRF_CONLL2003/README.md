...
```
LSTM+CRF实验结果：
accuracy:  94.00%; precision:  82.42%; recall:  68.51%; FB1:  74.83
              LOC: precision:  88.13%; recall:  77.11%; FB1:  82.25  1449
             MISC: precision:  75.72%; recall:  67.58%; FB1:  71.42  622
              ORG: precision:  75.72%; recall:  68.24%; FB1:  71.79  1487
              PER: precision:  87.77%; recall:  60.28%; FB1:  71.47  1096
```
### Result description:
